...
DEFAULT_DATASETS = [
    DatasetSpec(
        ...
        dynamic_source=Path("outputs/CUB_200_2011/CUB-200-2011-asym40-s42/v1_cub_asym_r0p4_s42/dynamic_loss"),
    ...
    DatasetSpec(
        ...
        dynamic_source=Path("outputs/Stanford_Cars/Stanford-Cars-asym40-s42/v1_cars_asym_r0p4_s42/dynamic_loss"),
    ...
    DatasetSpec(
        ...
        dynamic_source=Path("outputs/FGVC_Aircraft/FGVC-Aircraft-asym40-s42/v1_aircraft_asym_r0p4_s42/dynamic_loss"),
